...
$(document).ready(function(){
    //Отрезает текст по кол-ву символов
    var lettersToCut = 790;

    $(window).resize(function () {

        if (window.innerWidth < 1200) {
            lettersToCut = 500;
            var contentWrapper = $('.about__text');
            var contentWrapper2 = $('.price__info');
            var contentWrapper3 = $('.bar__text');
            var contentText = contentWrapper.text();
            var contentText2 = contentWrapper2.text();
            var contentText3 = contentWrapper3.text();
            contentText = contentText.substr(0, lettersToCut);
            contentText2 = contentText2.substr(0, lettersToCut);
            contentText3 = contentText3.substr(0, lettersToCut);
            contentWrapper.text(contentText);
            contentWrapper2.text(contentText2);
            contentWrapper3.text(contentText3);
            contentWrapper.append("... <a href='#popup__text' data-fancybox >Читать далее</a>");
            contentWrapper2.append("... <a href='#popup__text' data-fancybox >Читать далее</a>");
            contentWrapper3.append("... <a href='#popup__text' data-fancybox >Читать далее</a>");
        }
